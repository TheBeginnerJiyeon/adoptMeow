...
<body>
	...
	<form
		action="${pageContext.servletContext.contextPath}/cat/insert_form"
		method="get">
	...
	<form
		action="${pageContext.servletContext.contextPath}/cat/modify_form"
		method="post">
		<button type="submit">POST 고양이 수정 요청</button>
	</form>

	<h3>POST : /cat/delete</h3>
	<form action="${pageContext.servletContext.contextPath}/cat/delete"
		method="get">
	...
	<h3>GET : /cat/list</h3>
	<form action="${pageContext.servletContext.contextPath}/cat/list"
		method="get">
	...
	<button
		onclick="location.href='${pageContext.servletContext.contextPath}/cat/detail_form'">GET
		고양이 상세보기 요청</button>
	...
	<form
		action="${pageContext.servletContext.contextPath}/shelter/insert_form"
		method="get">
	...
	<form
		action="${pageContext.servletContext.contextPath}/shelter/modify_form"
		method="post">
	...
	<form
		action="${pageContext.servletContext.contextPath}/shelter/delete_form"
		method="post">
	...
	<form
		action="${pageContext.servletContext.contextPath}/shelter/list_form"
		method="get">
	...
	<button
		onclick="location.href='${pageContext.servletContext.contextPath}/shelter/detail_form'">GET
		보호소 상세보기 요청</button>
	...
	<form
		action="${pageContext.servletContext.contextPath}/board/insert_form"
		method="get">
	...
	<form
		action="${pageContext.servletContext.contextPath}/board/modify_form"
		method="post">
	...
	<form
		action="${pageContext.servletContext.contextPath}/board/delete_form"
		method="post">
	...
	<form
		action="${pageContext.servletContext.contextPath}/board/list_form"
		method="get">
	...
	<button
		onclick="location.href='${pageContext.servletContext.contextPath}/board/detail_form'">GET
		게시글 상세보기 요청</button>
