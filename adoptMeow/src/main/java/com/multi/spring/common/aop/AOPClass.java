...
public class AOPClass {
	...
	@Before("pointCut()")
	// 메소드가 실행되기 전에 공통으로 처리할 작업을 위해 사용
	public void before(JoinPoint join) {
		
		System.out.println("$$$$$$$$$$$로그인 기능 추가할 것$$$$$$$$$$$");
		
		Signature sig = join.getSignature();
		//AOP 가 적용되는 메소드의 정보반환
	...
	@After("pointCut()")
	// 예외 발생여부에 상관없이 비지니스 로직후 무조건 수행하는 기능을 작성하는 advice
	...
	// 정상적으로 비지니스 메소드가 리턴한 결과 데이터를 다른 용도로 처리할때.
	...
	@AfterThrowing(pointcut="pointCut()", throwing="exceptionObj" ) 
	//예외발생시 수행	
